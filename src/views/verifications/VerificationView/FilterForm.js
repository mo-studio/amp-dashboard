...
const FilterForm = ({
  ...
  const temp = taskService.formatTasksByCategories(unitSelectOptions(units));
  temp.then((test) => {
    let result = [];
    result = test.map((item) => item);
  });
...
FilterForm.propTypes = {
  ...
  officeSelectOptions: PropTypes.array.isRequired,
